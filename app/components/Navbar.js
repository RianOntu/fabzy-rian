  ...
  return (
    <>
      ...
      <div className="relative flex items-center h-[200px]">
        ...
        {/* why this is getting less height? */}
        <div className="flex items-center">
          {/* Navigation Menu */}
          <div className="border-r-[0.5px] w-[500px] h-[120px]">
              ...
              <div className="flex border-b-[0.5px]">
                <div className="border-r-[0.5px] w-[150px]">
                  <h1 className="text-xs text-[#5C5C5C] p-2 py-6">
                    {" "}
                    <i class="fa-solid fa-truck-fast mr-2 text-sm"></i>FREE
                    SHIPPING
                  </h1>
                </div>
                <div>
                  <h1 className="text-xs p-2 py-6 text-[#5C5C5C]">
                    <i class="fa-solid fa-gift mr-2 text-sm"></i>SPECIAL OFFER
                  </h1>
                </div>
              </div>
              <div>
          ...
          <div className="flex flex-col w-[300px]">
            <div className=" h-[120px]">
              <div className="flex ">
                <div className="border-r-[0.5px] w-[150px]">
                  <div className="flex items-center">
                    <i class="fa-solid fa-user text-sm mr-1 ml-1"></i>
                ...
                <div>
                  <div className="flex items-center">
                    <i class="fa-solid fa-cart-shopping text-sm mr-1 ml-1"></i>
                    <div className="flex flex-col p-4">
              ...
              <div className="relative">
                ...
                />
                <i class="fa-solid fa-magnifying-glass absolute right-[13px] top-[24px]"></i>
              </div>
            </div>
          </div>
        </div>
